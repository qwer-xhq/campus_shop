  ...
  <div class="">
      ...
      <el-table :data="userList" border style="width: 100%">
        ...
        <el-table-column label="状态" width="100px">
          <template v-slot="scope">
            <el-switch v-model="scope.row.user_state" @change="changeUserState(scope.row)"></el-switch>
          </template>
        </el-table-column>
    ...
    <el-dialog title="修改用户" :visible.sync="editDialogVisible" width="50%" @close="dialogClose('editFormRef')">
      <el-form :model="editForm" :rules="editFormRules" ref="editFormRef" label-width="70px">
        ...
        <el-form-item label="学习" prop="school">
  ...
  export default {
    ...
    methods: {
      ...
      changeUserState(userInfo) {
        ...
        this.$http.changeUserState({"user_id":userInfo.user_id, "user_state":userInfo.user_state}).then(res => {
          console.log(res)
          if (res.meta.status!==200) {
      ...
      showEditDialog(params) {
        ...
        console.log(params);
        this.editForm = Object.assign({},{user_id:params.user_id,user_name:params.user_name,mobile:params.mobile,email:params.email,school:params.school}) // 浅拷贝
      },
      ...
      editUserInfo() {
        this.$refs.editFormRef.validate(valid => {
          if (!valid) return
          this.$http.mgModifyUser(this.editForm).then(res => {
      ...
      setRole() {
        ...
        this.$http.changeUserRole({uid:this.userInfo.user_id,rid:this.roleId}).then(res => {
          if (res.meta.status !== 200) {
